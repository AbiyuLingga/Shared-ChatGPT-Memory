...
For deletion requests, incident reports, retention questions, or the current
data processor details, contact the address in `CONTACT_EMAIL`. Mem0 export and
retention options depend on the selected plan and must be verified before
production launch.
